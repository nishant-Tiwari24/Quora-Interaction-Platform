...
public:
    ...
    //     }
    //     cout << "Feeds anwered: "<< blog_id.size();
    //     // userFeeds(blog);
    // }
    ...
    void display() {
        ...
        cout << "\t\t\t\t\t\t\t|" << left << setw(columnWidth) << "Name" << "|" << left << setw(columnWidth) << name << "\t|" << endl;
        cout << "\t\t\t\t\t\t\t|" << left << setw(columnWidth) << "User Name" << "|" << left << setw(columnWidth) << username << "\t|" << endl;
        cout << "\t\t\t\t\t\t\t|" << left << setw(columnWidth) << "DOB" << "|" << left << setw(columnWidth) << dob << "\t|" << endl;
        cout << "\t\t\t\t\t\t\t|" << left << setw(columnWidth) << "Mail" << "|" << left << setw(columnWidth) << email << "\t|" << endl;
        cout << "\t\t\t\t\t\t\t|" << left << setw(columnWidth) << "Profession" << "|" << left << setw(columnWidth) << profession << "\t|" << endl;
        cout << "\t\t\t\t\t\t\t|" << left << setw(columnWidth) << "Description" << "|" << left << setw(columnWidth) << description << "\t|" << endl;
        cout << "\t\t\t\t\t\t\t|" << left << setw(columnWidth) << "Following" << "|" << left << setw(columnWidth) << following << "\t|" << endl;
        cout << "\t\t\t\t\t\t\t|" << left << setw(columnWidth) << "Followers" << "|" << left << setw(columnWidth) << followers << "\t|" << endl;
